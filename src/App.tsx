...
const helmetData = {
  ...
  dashboard: { title: "Student Dashboard | MARGDARSHAK", description: "Your central hub for academic progress and AI briefings." },
  aiChat: { title: "Margdarshak AI Tutor | Personal PCMB Assistant", description: "Get 1-on-1 academic help with Physics, Chemistry, Maths, and Biology using AI." },
  ...
  upgrade: { title: "Upgrade to Pro | MARGDARSHAK", description: "Unlock sovereign AI capabilities and unlimited storage." },
    ...
    <nav className="bg-[#080808] border-b border-white/5 text-white p-4 sticky top-0 z-50 backdrop-blur-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="ghost" onClick={() => navigate('/ai-chat')} className="text-xs font-bold text-emerald-400 hover:bg-emerald-500/10">AI Tutor</Button>
