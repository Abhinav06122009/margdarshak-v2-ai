...
export const ASIMonitor = ({ isProcessing }: { isProcessing: boolean }) => {
  ...
  return (
    <div className="flex items-center gap-6 px-6 py-2 bg-emerald-500/5 border-t border-white/5 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <span className="text-[9px] font-black uppercase tracking-widest text-emerald-500 animate-pulse">Neural Link: Online</span>
      </div>
    </div>
  );
};